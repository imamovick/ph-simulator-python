...
from gui.phscale import PhIndicator  # Assuming PhIndicator is correctly defined as a tk.Frame subclass
...
def main():
    ...
    beaker.grid(row=2, column=1, sticky="nsew", padx=10, pady=50)
