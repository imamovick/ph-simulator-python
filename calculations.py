...
def get_Ba_OH_2_Hplus(Ba_OH_2_conc):
    return Kw / (2*Ba_OH_2_conc)

# Calcium Hydroxide, strong base
def get_CA_OH_2_Hplus(CA_OH_2_conc):
    return Kw / (2*CA_OH_2_conc)

# Sodium Hydroxide, strong base
def get_NaOH_Hplus(NaOH_conc):
    return Kw / NaOH_conc

# Ammonium Hydroxide, weak base
def get_NH4OH_Hplus(NH4OH_conc):
    return Kw/math.sqrt(Kb_ammonia*NH4OH_conc)

# Hydrochloric Acid, strong acid
def get_HCl_Hplus(HCl_conc):
    return HCl_conc

# Nitric Acid, strong acid
def get_HNO3_Hplus(HNO3_conc):
    return HNO3_conc

# Acetic Acid, weak acid
def get_HC2H3O2_Hplus(HC2H3O2_conc):
    return math.sqrt(Ka_acetic_acid*HC2H3O2_conc)

# Carbonic Acid, weak acid
def get_H2CO3_Hplus(H2CO3_conc):
...
def get_excess_Hplus(drops, M_HCl, NaC2H3O2_conc):
